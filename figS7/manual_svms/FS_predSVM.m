...
for d = 1:3
    ...
    for a = 1:length(animals)
        ...
        tmprv = nan(length(trialTbl.trialId), length(cellnames));
        ...
        for iTrial = 1:numSamplesC
            ...
            % Train the SVM model
            mdlC = fitcsvm(xTrain, yTrainC, 'KernelFunction', 'Linear', 'Prior', 'empirical');
            mdlD = fitcsvm(xTrain, yTrainD, 'KernelFunction', 'Linear', 'prior', 'empirical');
